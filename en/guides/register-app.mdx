...
| `avatar_url`    | string   | No       | HTTPS URL of your app logo. Vendaze fetches the image, validates it, and stores it. Accepted formats: JPEG, PNG, WebP, GIF, BMP, TIFF. SVG is not accepted. Max 2MB. |
