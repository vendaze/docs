...
<Note>
  Scopes cannot be changed via rotation. If you need different scopes, you need to register a new
  app with a different email address, since each email can only be associated with one registered
  app.
</Note>
