...
Workspaces do Vendaze podem definir campos adicionais para capturar dados que não se encaixam no schema padrão: CNPJ, origem do lead, segmento, pontuação interna, e qualquer outra informação relevante para o processo comercial.
