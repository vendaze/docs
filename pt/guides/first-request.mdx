...
description: 'Guia completo do registro até a sua primeira chamada real à API do Vendaze.'
icon: 'terminal'
---
...
- Conta no Vendaze com pelo menos um workspace ativo
...
Você será redirecionado para o Vendaze, onde vai:
  ...
  "data": [
    {
      ...
      "phones": [{ "value": "+5511999990001", "label": "mobile" }],
