...
description: 'Obtenha suas credenciais de cliente para começar a construir uma integração com o Vendaze.'
icon: 'plug'
---

Antes que seu aplicativo possa autenticar usuários do Vendaze, você precisa registrá-lo. O registro é aberto a qualquer desenvolvedor, sem processo de aprovação. Suas credenciais chegam por e-mail em segundos.
...
curl -X POST https://api.vendaze.com/v1/auth/register-app \
  ...
  -d '{
    ...
    "description": "Sincroniza contatos e negócios entre o Vendaze e o MeuApp",
...
<Card title="Autenticação" icon="lock" href="/pt/guides/authentication">
  Implemente o fluxo OAuth 2.1 para autorizar usuários do Vendaze no seu aplicativo.
</Card>
