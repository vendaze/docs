...
<Note>
  Os escopos não podem ser alterados via rotação. Para solicitar escopos diferentes, é necessário
  registrar um novo aplicativo com um endereço de e-mail diferente, já que cada e-mail só pode estar
  associado a um aplicativo registrado.
</Note>
